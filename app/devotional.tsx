    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      >
        <Animated.View entering={FadeIn.duration(500)}>
          ...
          >
            <Ionicons name="book-outline" size={20} color={theme.tint} style={{ marginBottom: 12 }} />
        ...
        {showReflection && (
          <Animated.View entering={FadeIn.duration(300)}>
            <View style={[styles.reflectionInput, { backgroundColor: isDark ? 'rgba(255,255,255,0.04)' : 'rgba(0,0,0,0.02)', borderColor: theme.border }]}>
              <TextInput
                style={[styles.reflectionTextInput, { color: theme.text, fontFamily: 'Inter_400Regular' }]}
                placeholder="What spoke to you today? Write your reflection..."
              ...
              <View style={styles.reflectionActions}>
                <Pressable onPress={() => setShowReflection(false)}>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, lineHeight: 36, marginBottom: 20 },
  scriptureCard: { borderRadius: 20, padding: 24, marginBottom: 28 },
  ...
  prayerCard: { borderRadius: 16, padding: 20, borderWidth: 1, marginBottom: 24 },
  ...
  primaryButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 16, borderRadius: 14 },
  primaryButtonText: { color: '#fff', fontSize: 16 },
  secondaryButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 14, borderRadius: 14, borderWidth: 1 },
  secondaryButtonText: { fontSize: 15 },
  readBadge: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 14, borderRadius: 14 },
  readBadgeText: { fontSize: 15 },
  reflectionInput: { borderRadius: 16, padding: 18, borderWidth: 1 },
  reflectionTextInput: { fontSize: 15, lineHeight: 24, minHeight: 120 },
  reflectionActions: { flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center', gap: 16, marginTop: 12 },
  cancelText: { fontSize: 15 },
  saveButton: { paddingHorizontal: 20, paddingVertical: 10, borderRadius: 10 },
